    ...
    <div className="min-h-screen flex bg-black">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-white/5 items-center justify-center p-12">
        <div className="max-w-md text-white">
          ...
          <h1 className="text-4xl font-bold leading-tight mb-4">Start your reading journey today</h1>
          <p className="text-white/50 text-lg leading-relaxed">
            Create a free account to upload your PDFs, listen with AI voices, and explore thousands of free ebooks.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-white/50 mb-8">Sign up to get started</p>
          ...
          <p className="mt-8 text-center text-sm text-white/40">
            ...
            <Link href="/login" className="text-brand-400 hover:text-brand-300 hover:underline font-semibold">
              Sign in
            </Link>
          </p>
        </div>
